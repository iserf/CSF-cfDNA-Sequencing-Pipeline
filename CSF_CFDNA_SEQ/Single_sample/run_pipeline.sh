...
date | tee -a $LOG_FILE
$pipeline_DIR/classify_variants_2.sh $ID_T $BAM_T $home_dir $classifier $BED 2>>$ERROR_FILE 1>>$LOG_FILE
wait
...
date | tee -a $LOG_FILE
$pipeline_DIR/Create_oncoprint_file.sh $ID_T $home_dir _single
wait
