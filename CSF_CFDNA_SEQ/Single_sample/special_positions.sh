...
#RAW BAM#
#create mpileup
docker run --rm -v ${home_dir}:${home_dir} -u $UID --memory 200G 31071993/cfdna_pipeline_v2:pipeline_v2_special /bin/bash -c \
"bcftools mpileup \
...
#Funcotation
docker run --rm -v ${home_dir}:${home_dir} -u $UID --memory 200G 31071993/cfdna_pipeline_v2:pipeline_v2_special \
gatk Funcotator \
