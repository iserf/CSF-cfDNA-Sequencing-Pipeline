...
echo -e $training'\t'$ID'\t'$seed'\t'$SNV_truth_set'\t'$SNV_total'\t'$SNV_found'\t'$sensitivity_SNV'\t'$specificity_SNV'\t'$Indel_truth_set'\t'$Indel_total'\t'$Indel_found'\t'$sensitivity_Indel'\t'$specificity_Indel >> $OUT_DIR/report.${training}.txt
