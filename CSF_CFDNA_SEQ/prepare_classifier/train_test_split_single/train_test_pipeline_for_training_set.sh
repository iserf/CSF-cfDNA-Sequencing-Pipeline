...
workdir=/home/iser/cfDNA_docker/pipeline_v2/prepare_classifier/train_test_split_single

seeds=(42 117 67403 83926 4910296)
IDs=(274040 274044 274042 274046 279690)
...
echo -e Training'\t'ID'\t'Caller_file'\t'Mode'\t'Variants_found'\t'total_variants'\t'sensitivity'\t'specificity >> /home/iser/cfDNA_docker/reference/somaticseq_training/$training/report/report.single_callers.txt
...
# #Find true variants in 20% test data for calculation of sensitivity and specificity
# IDs=(274040 274042v1 274044 274046v1 279690)
# for j in "${IDs[@]}"
# do
#     for i in "${seeds[@]}"
#     do
#        $workdir/test_truth_intersect.sh $training $i $j
#     done
# done
# wait
...
# touch /home/iser/cfDNA_docker/reference/somaticseq_training/$training/report/report.${training}.txt
# echo -e Training'\t'ID'\t'Seed'\t'SNV_truth_set'\t'SNV_total'\t'SNV_overlap'\t'Sensitivity_SNV'\t'Specificity_SNV'\t'Indel_truth_set'\t'Indel_total'\t'Indel_overlap'\t'Sensitivity_Indel'\t'Specificity_Indel \
# >> /home/iser/cfDNA_docker/reference/somaticseq_training/$training/report/report.${training}.txt

# for j in "${IDs[@]}"
# do
#     for i in "${seeds[@]}"
#     do
#        $workdir/write_to_file.sh $training $i $j
#     done
# done
